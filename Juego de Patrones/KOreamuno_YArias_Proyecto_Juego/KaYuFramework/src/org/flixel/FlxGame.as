package org.flixel
{
	...
	public class FlxGame extends Sprite
	{
		 ...
		 */
		protected var _iState:KYEstadoNivel;
		/**
		 ...
		 */
		public function setInit(objConfig:KYConfigJuego, GameFramerate:uint = 60, FlashFramerate:uint = 30, UseSystemCursor:Boolean = false):void {
			...
			FlxG.init(this, objConfig.getAnchoPantalla(), objConfig.getLargoPantalla(), objConfig.getZoom());
		...
		public function startGame(objNivel:KYNivel):void {
			_nivel = objNivel;
			_iState = objNivel.getEstadoActual();
		 ...
		 */
		protected function switchState(objEstado:KYNivel):void
		{ 
			//Basic reset stuff
			FlxG.resetCameras();
			FlxG.resetInput();
