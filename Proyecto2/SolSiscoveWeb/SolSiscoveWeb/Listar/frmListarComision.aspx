<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="frmListarComision.aspx.vb" Inherits="SolSiscoveWeb.frmListarComision" 
    title="Lista Comisión" %>
<%@ Register assembly="EO.Web" namespace="EO.Web" tagprefix="eo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divPrincipal" style="height: 400px; width:1029px; padding-top:20px;">
        ...
        <td> 
         ...
         <%-- Textbox Monto--%>
        <div id="divlblComision" style="text-align:left; width:425px;">
            <asp:Label ID="lblVerComision" runat="server" Text="Comisión" 
                Font-Names="Arial" Font-Size="11pt" Visible="False"></asp:Label>
        </div>
        
         <%-- Grid Linea Detalle--%>
        <div id="divgridComision">  
            <eo:Grid runat="server" id="gridComision" BorderColor="#828790" 
                                BorderWidth="1px" GridLines="Both"
	                            FixedColumnCount="1" ColumnHeaderDescImage="00050205" 
                                GridLineColor="240, 240, 240" Width="424px"
                ...
                ColumnHeaderAscImage="00050204" ColumnHeaderHeight="24"
	                            ...
	                            <Columns>
                                    ...
                                    <eo:StaticColumn Width="200" HeaderText="Tipo Comisión" DataField="tipoComision"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="120" HeaderText="Monto Comisión" DataField="montoPagado"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="120" HeaderText="Estado Comisión" DataField="estado"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="codigo"></eo:StaticColumn>
 
                                    <eo:StaticColumn Width="40" Visible="false" DataField="fechaEmision"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="fechaInicial"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="fechaFinal"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="fechaCancelacion"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="porcentajeComision"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="montoMeta"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="montoAlcanzado"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="cantidadMeta"></eo:StaticColumn>
                                    
                                    <eo:StaticColumn Width="40" Visible="false" DataField="cantidadAlcanzada"></eo:StaticColumn>
