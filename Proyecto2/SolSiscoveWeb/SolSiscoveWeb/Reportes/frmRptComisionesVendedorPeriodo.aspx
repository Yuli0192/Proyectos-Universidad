<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="frmRptComisionesVendedorPeriodo.aspx.vb" Inherits="SolSiscoveWeb.frmRptComisionesVendedorPeriodo" 
    title="Total Comisiones Por Vendedor Por Periodo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divPrincipal" style=" height:650px; width: 1029px; padding-top:20px;">
        ...
        <div id="divComisiones">
            <asp:Label ID="lblTotalComisiones" runat="server" Font-Names="Arial" 
                Font-Size="20pt" ForeColor="#000066" 
                Text="Reporte Total Comisiones Por Vendedor  Por Periodo"></asp:Label>
         
        </div>
        
         <table style="width:800px; padding-top:20px; padding-bottom:20px;">
       <tr>
       ...
       <td><eo:DatePicker ID="dtpFechaFin" runat="server" ControlSkinID="None" 
                ...
                <td> <asp:Label ID="lblUsuario" runat="server" Font-Names="Arial" Font-Size="11pt" Text="Cédula Usuario"></asp:Label>
            <asp:TextBox ID="txtCedula" runat="server" Font-Names="Arial" Font-Size="11pt" 
        ...
        <div id="divCrystal" style="height:450px; overflow-x:none; overflow-y:scroll;" >
            ...
            <CR:CrystalReportSource ID="crs1" runat="server">
	            <Report FileName="~/Reportes/ReporteTotalComisionesVededorPorPeriodo.rpt">
		            <Parameters>
		                <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
                            DefaultValue="00000000" Name="idusuario" PropertyName="" ReportName="" />
		                <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
