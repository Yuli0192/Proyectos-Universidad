<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="frmRptComisionesPor2Periodos.aspx.vb" Inherits="SolSiscoveWeb.frmRptComisionesPor2Periodos" 
    title="Reporte Comisiones por Dos Periodos de Tiempo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="divPrincipal" style=" height:650px; width: 1029px; padding-top:20px;">
        ...
        <div id="divlblRptComisiones">
            <asp:Label ID="lblComisionesPorPeriodo" runat="server" Font-Names="Arial" Font-Size="20pt" ForeColor="#000066" Text="Reporte Por Dos Periodos De Tiempo"></asp:Label>
        </div>
       <table style="width:750px; padding-top:20px; padding-bottom:20px;">
       ...
       <td>
            ...
            <asp:RadioButtonList ID="rblCriterio" runat="server" Width="270px" RepeatLayout="Flow" RepeatDirection="Horizontal" >
                        <asp:ListItem Value="rbtMensual" Selected="True">Mensual</asp:ListItem>
                        <asp:ListItem Value="rbtTrimestral">Trimestral</asp:ListItem>
                        <asp:ListItem Value="rbtAnual">Anual</asp:ListItem>
       ...
       <td><eo:DatePicker ID="dtpFechaFin" runat="server" ControlSkinID="None" 
        ...
        <div id="divCrystal" style="height:450px; overflow-x:none; overflow-y:scroll;">
            ...
            <CR:CrystalReportSource ID="crs1" runat="server">
	            <Report FileName="~/Reportes/rptComisionesPorMes.rpt">
		            <Parameters>
		                <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
                            DefaultValue="01/01/2000" Name="fechainicio1" PropertyName="" ReportName="" />
			            <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
                            DefaultValue="01/02/2000" Name="fechafin1" PropertyName="" ReportName="" />
                        <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
                            DefaultValue="01/01/2000" Name="fechainicio2" PropertyName="" ReportName="" />
			            <CR:ControlParameter ControlID="" ConvertEmptyStringToNull="False" 
                            DefaultValue="01/02/2000" Name="fechafin2" PropertyName="" ReportName="" />    
		            </Parameters>
	            </Report>
