...
Public Class rptCCVentasRealizadas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCCVentasRealizadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CllInterfazGrafica.rptCCVentasRealizadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idgrupo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCCVentasRealizadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCCVentasRealizadas = New rptCCVentasRealizadas
        rpt.Site = Me.Site
        Return rpt
    End Function
